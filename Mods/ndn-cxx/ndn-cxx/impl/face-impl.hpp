...
public: // producer
  ...
  {
    // std::cerr<<"processincominginterest: "<<*interest<<" pit token at ndn-cxx: "<<readInterestPitToken(*interest)<<std::endl;
...
private:
  ...
  {
    // std::cerr<<"Interest: "<<interest<<" pit token at ndn-cxx: "<<readInterestPitToken(interest)<<std::endl;
